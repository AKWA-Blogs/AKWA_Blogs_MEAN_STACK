...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(element, _httpService, router) {
        this.element = element;
        this._httpService = _httpService;
        this.router = router;
        this.test = new Date();
        ...
        this.confirmFormControl = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]('', [
            _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required,
            _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].minLength(8)
        ]);
    ...
    RegisterComponent.prototype.onSubmit = function () {
        ...
        var observable = this._httpService.postSignUp(this.newUser);
        observable.subscribe(function (data) {
            console.log('done! ', data['token']);
            var user = jwt_decode__WEBPACK_IMPORTED_MODULE_3__(data['token']);
            localStorage.setItem('id', user.id);
